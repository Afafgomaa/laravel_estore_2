...
class Index extends Model
{
    ...
    public function slidesByCarousel($currentDate, $carousel_id)
    {
        ...
        ->where('sliders_images.status', '=', '1')
			 ...
			 ->where('sliders_images.carousel_id', '=', $carousel_id)
			 ->where('sliders_images.languages_id', '=', session('language_id'))
    ...
    public function commonContent()
    {
        ...
        $result['pages'] = DB::table('pages')
            ...
            //->orwhere([['type', '2'], ['status', '1'], ['pages_description.language_id', 1]])
