                        ...
                        <div class="box-body">
                            ...
                            @for ($i = 0; $i < $all_count; $i++)
                                        ...
                                        @if(count($listingOrders[$i][0]['orders'])>0)
                                            @foreach ($listingOrders[$i][0]['orders'] as $key=>$orderData)
                                                <tr>
                                                    <td>{{ $orderData->orders_id }}</td>
                                                    <td>{{ $orderData->customers_name }}</td>
                                                    <td>{{ $listingOrders[$i][0]['currency'][19]->value }}{{ $orderData->order_price }}</td>
                                                    ...
                                                    <td>
                                                         <a data-toggle="tooltip" data-placement="bottom" title="View Order" href="vieworderforshipping/{{ $orderData->orders_id }}" class="badge bg-light-blue"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        ...
                                        <!-- <div class="col-xs-12 text-right">
                                            {{$listingOrders[$i][0]['orders']->links()}}
                                        </div> -->
                                          @endfor
                                    </table>
