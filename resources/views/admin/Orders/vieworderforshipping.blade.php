        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tr>
                ...
                <td> {{$products->address1}}  / {{$products->address2}} / {{$products->city}} 
                <address>
            <strong>{{ $products->First_Name }}</strong><br>
            {{ $products->address1 }} <br>
            {{ $products->city }}, {{ $products->address2 }} {{ $products->Zip_Code }}, {{ $products->countery }}<br>
