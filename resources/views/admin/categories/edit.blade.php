                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        @endforeach
                                          @foreach($result['sort'] as $key=>$sort)
                                        
                                          <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">sort_order<span style="color:red;">*</span> </label>
                                            <div class="col-sm-10 col-md-4">
                                              
                                                <input name="sort_order" class="form-control field-validate" type="number" value=<?php if($sort->parent_id==0){echo $sort->sort_order;}
                                        else{echo $sort->sub_sort_order;}
                                      ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                ...
                                                <div id="imageselected">
                                                    {!! Form::button('add Image name', array('id'=>'newIcon','class'=>"btn btn-primary ", 'data-toggle'=>"modal", 'data-target'=>"#ModalmanufacturedICone" )) !!}
                                                    <br>
                                    ...
                                    <img src="{{asset('/images/media/2020/04/'.$image_left[0]->name)}}"
             style="    width: 120px;
    margin-left: 25%;">      
                                   ...
                                   <img src="{{asset('/images/media/2020/04/'.$image_right[0]->name)}}"
             style="    width: 120px;
    margin-left: 25%;">            
                                         ...
                                         <div class="form-group" id="imagename">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                ...
                                                <div id="imageselected">
                                                  {!! Form::button(trans('labels.Add Icon'), array('id'=>'newname','class'=>"btn btn-primary field-validate", 'data-toggle'=>"modal", 'data-target'=>"#Modalmanufacturedimage" )) !!}
                                                  <br>
                                        ...
                                        <img src="{{asset('/images/media/2020/04/'.$Image_name[0]->name)}}"
             style="    width: 120px;
    margin-left: 25%;">       
